...
function MainContent() {
          ...
          >
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="relative w-36 h-36 md:w-48 md:h-48 rounded-full overflow-hidden border-4 border-white shadow-xl backdrop-blur-md">
                <img
                  data-aos="zoom-in"
                  src="/img"  // Update this path as needed
                  alt="Sonu Maddheshiya"
                  className="w-full h-full object-cover"
                />
              </div>
              {/* Developer Description */}
              <div className="bg-black bg-opacity-40 p-8 rounded-lg shadow-lg mt-8 backdrop-blur-xl w-full max-w-4xl">
                <h3 data-aos="fade-up" className="text-xl md:text-2xl font-semibold text-white mb-4 " >Sonu Maddheshiya</h3>
  ...
  <div className="glass-box p-6 mb-4 max-w-[768] text-left break-words" data-aos="fade-right">
    <p data-aos="fade-left" className="text-gray-300 mb-4" >
      Hi, I'm Sonu Maddheshiya, currently pursuing a BTech in Computer Science and Engineering from GNIOT, Greater Noida, Delhi NCR. I am an enthusiastic and self-motivated individual with a strong passion for learning and exploring new things.
    </p>
  </div>
