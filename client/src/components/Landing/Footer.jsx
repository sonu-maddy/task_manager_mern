      ...
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm">Developed by <strong>Mr. Sonu Maddheshiya</strong></p>
            <p className="text-sm">Email: <a href="" className="hover:text-blue-400">sonu@gmail.com</a></p>
            <p className="text-sm">Phone: <a href="tel:" className="hover:text-blue-400">6307016696</a></p>
          </div>
        </div>
        ...
        <div className="mt-8">
          <p className="text-sm">
            &copy; {new Date().getFullYear()} <span className="font-semibold">Developed by Mr.Sonu Maddheshiya</span>. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
